...
🔭 Estudante de Análise e Desenvolvimento de Sistemas<br>🔭 Desenvolvedor Backend - C# - .NET - ASP.NET CORE MVC - REACT.JS<br>👯 Estou a procura de uma vaga Jr ou Estágio.<br>🌱 Meu foco atualmente é em MVC e APIrest, REACT.JS<br>💬Pergunte-me sobre programação em C# e desenvolvimento web.
